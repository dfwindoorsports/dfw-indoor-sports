   ...
   return (
      <div className="relative h-[60vh] min-h-[400px] flex items-center bg-dfw-navy overflow-hidden">
         ...
         <div className="container mx-auto px-4 md:px-6 relative z-20 pt-10">
            ...
            >
               ...
               <div className="hidden md:flex gap-6 border-l border-white/10 pl-6">
                  <div>
                     ...
                     <div className="text-\[11px\] font-medium text-gray-500 uppercase tracking-widest font-mono">Personal Attention</div>
                  </div>
                  <div>
                     <div className="text-xl font-header font-bold text-white">Age 5+</div>
                     <div className="text-\[11px\] font-medium text-gray-500 uppercase tracking-widest font-mono">To Elite Level</div>
                  </div>
               </div>
            </motion.div>
            ...
            >
               <a href="https://ams-app.skonnect.io/player/register?center__code=C-A144&sport=1" target="_blank" rel="noopener noreferrer" className="group relative px-6 py-3 bg-dfw-red text-white font-bold uppercase tracking-widest text-xs rounded-lg overflow-hidden shadow-[0_0_40px_rgba(214,40,40,0.4)] transition-all hover:shadow-[0_0_60px_rgba(214,40,40,0.6)] hover:-translate-y-1 inline-flex">

                  <span className="relative flex items-center gap-3">Register Now <ChevronRight size={14} /></span>
               </a>
               <a href="/contact" className="px-6 py-3 border border-white/20 bg-white/5 backdrop-blur-md text-white font-bold uppercase tracking-widest text-xs rounded-lg hover:bg-white hover:text-dfw-navy transition-all flex items-center gap-3 inline-flex">
