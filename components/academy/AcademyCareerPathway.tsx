...
const AcademyCareerPathway: React.FC = () => {
 ...
 return (
 <section className="bg-gradient-to-b from-white to-gray-50 dark:from-[#0A111F] dark:to-[#0f172a] py-24 border-y border-gray-200 relative overflow-hidden transition-colors duration-300">
 ...
 <motion.h2
 className="text-4xl md:text-5xl font-header font-bold text-white uppercase leading-none mb-6"
 >
 ...
 >
 <motion.div variants={itemVariants} className="bg-white/5 p-8 rounded-2xl border border-white/10 shadow-xl dark:shadow-none relative overflow-hidden group">
 ...
 <h3 className="text-2xl font-header font-bold text-white">Players Pathway</h3>
 </div>
 ...
 <h3 className="text-2xl font-header font-bold text-white">Coaches Pathway</h3>
 </div>
 <p className="text-gray-300 leading-relaxed text-sm">
 ...
 >
 {/* Beginners Card */}
 <motion.div variants={itemVariants} className={`bg-white/5 rounded-2xl border border-white/10 p-1 overflow-hidden hover:shadow-xl transition-all duration-300 ${activeLevel && activeLevel !== 'Beginners' ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100 scale-100 ring-2 ring-blue-500/20'}`}>
 <div className="h-2 bg-gradient-to-r from-[#42A5F5] to-[#1565C0] rounded-t-xl"></div>
 <div className="p-6">
 <div className="flex justify-between items-start mb-4">
 <div className="p-2 bg-blue-900/20 rounded-lg text-[#1565C0]">
 <User size={24} />
 </div>
 <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Level 1</span>
 </div>
 <h4 className="text-xl font-header font-bold text-white mb-4">Beginners</h4>

 <div className="space-y-4">
 <div className="flex items-center gap-3 text-sm text-gray-300 bg-[#050911] dark:bg-white/5 p-3 rounded-lg">
 ...
 {/* Intermediate Card */}
 <motion.div variants={itemVariants} className={`bg-white/5 rounded-2xl border border-white/10 p-1 overflow-hidden hover:shadow-xl transition-all duration-300 ${activeLevel && activeLevel !== 'Intermediate' ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100 scale-100 ring-2 ring-green-500/20'}`}>
 <div className="h-2 bg-gradient-to-r from-[#66BB6A] to-[#2E7D32] rounded-t-xl"></div>
 <div className="p-6">
 <div className="flex justify-between items-start mb-4">
 <div className="p-2 bg-green-900/20 rounded-lg text-[#2E7D32]">
 <Users size={24} />
 </div>
 <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Level 2</span>
 </div>
 <h4 className="text-xl font-header font-bold text-white mb-4">Intermediate</h4>
 ...
 {/* Advance Card */}
 <motion.div variants={itemVariants} className={`bg-white/5 rounded-2xl border border-white/10 p-1 overflow-hidden hover:shadow-xl transition-all duration-300 ${activeLevel && activeLevel !== 'Advance' ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100 scale-100 ring-2 ring-orange-500/20'}`}>
 <div className="h-2 bg-gradient-to-r from-[#FF9800] to-[#EF6C00] rounded-t-xl"></div>
 <div className="p-6">
 <div className="flex justify-between items-start mb-4">
 <div className="p-2 bg-orange-900/20 rounded-lg text-[#EF6C00]">
 <Star size={24} />
 </div>
 <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Level 3</span>
 </div>
 <h4 className="text-xl font-header font-bold text-white mb-4">Advance</h4>
 ...
 {/* Elite Card */}
 <motion.div variants={itemVariants} className={`bg-white/5 rounded-2xl border border-white/10 p-1 overflow-hidden hover:shadow-xl transition-all duration-300 ${activeLevel && activeLevel !== 'Elite' ? 'opacity-40 grayscale blur-[1px]' : 'opacity-100 scale-100 ring-2 ring-red-500/20'}`}>
 <div className="h-2 bg-gradient-to-r from-[#E53935] to-[#C62828] rounded-t-xl"></div>
 <div className="p-6">
 <div className="flex justify-between items-start mb-4">
 <div className="p-2 bg-red-900/20 rounded-lg text-[#C62828]">
 <Trophy size={24} />
 </div>
 <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Level 4</span>
 </div>
 <h4 className="text-xl font-header font-bold text-white mb-4">Elite</h4>
