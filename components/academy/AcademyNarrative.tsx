...
const AcademyNarrative: React.FC = () => {
 ...
 >
 {/* Image Composition */}
 <div className="relative rounded-lg overflow-hidden shadow-2xl group border border-white/10">
 ...
 {/* Floating Stat Card */}
 <div className="absolute bottom-6 left-6 right-6 bg-white/95 /90 backdrop-blur-xl p-6 rounded-sm border border-white/20 shadow-lg z-20">
 <div className="flex justify-between items-end">
 <div>
 <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Our Promise</p>
 <h4 className="text-white font-header font-bold text-xl uppercase">Every Player Matters</h4>
 </div>
 ...
 <div className="prose prose-lg text-gray-400 leading-relaxed mb-8">
 <p>
 ...
 className="flex items-start gap-4 p-4 rounded-lg bg-[#050911] dark:bg-[#0A111F] border border-gray-100 hover:border-dfw-red/20 transition-colors group cursor-default"
 >
 ...
 <div>
 <h4 className="text-sm font-bold text-white uppercase tracking-wide mb-1">{item.title}</h4>
