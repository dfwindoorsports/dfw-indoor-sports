...
const AcademyPrograms: React.FC = () => {
 ...
 return (
 <section className="bg-[#050911] py-24 border-y border-gray-200 relative overflow-hidden transition-colors duration-300">
 {/* Background Texture */}
 ...
 <p className="text-gray-400 mt-4">Structured pathways for every stage of the athlete's journey.</p>
 </div>
 <div className="hidden md:block">
 <button className="flex items-center gap-2 text-xs font-bold text-white uppercase tracking-widest border-b border-dfw-navy dark:border-white pb-1 hover:text-dfw-red dark:hover:text-dfw-red hover:border-dfw-red dark:hover:border-dfw-red transition-all">
 ...
 <motion.div variants={itemVariants} className="group bg-white/5 rounded-lg border border-white/10 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col h-full">
 ...
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Foundation</h3>
 ...
 <button className="w-full py-3 border border-gray-200 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm group-hover:bg-green-600 group-hover:text-white group-hover:border-green-600 transition-colors">Details</button>
 </div>
 </motion.div>
 ...
 <div className="p-6 flex flex-col flex-grow">
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Development</h3>
 ...
 <button className="w-full py-3 border border-gray-200 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 transition-colors">Details</button>
 </div>
 </motion.div>
 ...
 <div className="p-6 flex flex-col flex-grow">
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Adult Club</h3>
 ...
 <button className="w-full py-3 border border-gray-200 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm group-hover:bg-orange-500 group-hover:text-white group-hover:border-orange-500 transition-colors">Details</button>
 </div>
 </motion.div>
 </motion.div>
 </div>
