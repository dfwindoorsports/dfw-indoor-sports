...
const InvestmentLevels: React.FC = () => {
  ...
  return (
    <section aria-label="Investment levels" className="py-24 md:py-32 bg-gray-50 border-t border-gray-200 transition-colors duration-300">
       <div className="container mx-auto px-4 md:px-6">
          ...
          >
             ...
             {/* Bronze */}
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm hover:border-dfw-navy transition-all relative group h-min">
                <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-2">Bronze</h3>
             ...
             {/* Silver */}
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm hover:border-dfw-navy transition-all relative group h-min">
                <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-2">Silver</h3>
                <div className="text-3xl font-bold text-gray-700 mb-6">Contact<span className="text-xs font-normal text-gray-400 ml-1">/mo</span></div>
                <ul className="space-y-4 mb-8">
                   <li className="flex gap-3 text-xs text-gray-900 font-bold"><Check size={14} className="text-dfw-navy" /> All Bronze Benefits</li>
             ...
             {/* Platinum */}
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm hover:border-dfw-navy transition-all relative group h-min">
                <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-2">Platinum</h3>
                <div className="text-3xl font-bold text-gray-700 mb-6">Contact<span className="text-xs font-normal text-gray-400 ml-1">/mo</span></div>
                <ul className="space-y-4 mb-8">
                   <li className="flex gap-3 text-xs text-gray-900 font-bold"><Check size={14} className="text-dfw-navy" /> All Gold Benefits</li>
