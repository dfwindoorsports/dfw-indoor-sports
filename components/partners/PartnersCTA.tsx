...
const PartnersCTA: React.FC = () => {
 ...
 >
 {isSubmitted ? (
 <div className="bg-[#0A111F] p-8 md:p-10 rounded-xl shadow-2xl border border-white/10 text-center py-24">
 <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6">
 <CheckCircle2 size={32} className="text-white" />
 </div>
 <h3 className="font-header font-bold text-white uppercase text-2xl mb-2">Proposal Requested</h3>
 <p className="text-gray-400">Our partnerships team will review your details and contact you within 24 hours.</p>
 ...
 <form onSubmit={handleSubmit} className="bg-[#0A111F] p-8 md:p-10 rounded-xl shadow-2xl space-y-6 relative overflow-hidden border border-white/10">
 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-dfw-red to-red-600"></div>

 <h3 className="font-header font-bold text-white uppercase text-2xl mb-2">Request Proposal</h3>
 <p className="text-xs text-gray-400 mb-6">Fill out the form below and our partnerships team will be in touch within 24 hours.</p>

 <div className="grid grid-cols-2 gap-6">
 <div className="relative group">
 <input required type="text" className="peer w-full border-b border-gray-300 py-2 text-sm text-white focus:outline-none focus:border-dfw-red transition-colors bg-transparent placeholder-transparent" id="firstName" placeholder="First Name" value={formData.firstName} onChange={handleChange} />
 ...
 <div className="relative group">
 <input required type="text" className="peer w-full border-b border-gray-300 py-2 text-sm text-white focus:outline-none focus:border-dfw-red transition-colors bg-transparent placeholder-transparent" id="lastName" placeholder="Last Name" value={formData.lastName} onChange={handleChange} />
 ...
 <div className="relative group">
 <input required type="text" className="peer w-full border-b border-gray-300 py-2 text-sm text-white focus:outline-none focus:border-dfw-red transition-colors bg-transparent placeholder-transparent" id="company" placeholder="Company" value={formData.company} onChange={handleChange} />
 ...
 <div className="relative group">
 <input required type="email" className="peer w-full border-b border-gray-300 py-2 text-sm text-white focus:outline-none focus:border-dfw-red transition-colors bg-transparent placeholder-transparent" id="email" placeholder="Email" value={formData.email} onChange={handleChange} />
 ...
 <div className="relative group">
 <select id="level" value={formData.level} onChange={handleChange} className="w-full border-b border-gray-300 py-2 text-sm text-gray-400 focus:outline-none focus:border-dfw-red bg-transparent cursor-pointer dark:bg-[#0A111F]">
 ...
 {errorMessage && (
 <div className="bg-red-900/20 border border-red-200 dark:border-red-500/30 p-3 rounded text-red-400 text-xs">
 {errorMessage}
 </div>
 )}
