...
const PartnersProcess: React.FC = () => {
 ...
 >
 <h2 className="text-3xl font-header font-bold text-white uppercase mb-4">How It Works</h2>
 <p className="text-gray-400">Four simple steps to launching your partnership.</p>
 </motion.div>
 ...
 {/* Step Circle */}
 <div className="w-14 h-14 bg-[#0A111F] border-2 border-gray-100 rounded-full flex items-center justify-center font-bold font-header text-xl text-white mb-6 group-hover:border-dfw-red group-hover:text-dfw-red transition-all duration-300 shadow-sm relative z-10">
 {item.step}
 </div>
 
 <div className="bg-white/5 p-6 border border-white/10 rounded-lg shadow-sm hover:shadow-lg transition-all w-full h-full">
 <h4 className="font-bold text-white uppercase mb-3 text-sm">{item.title}</h4>
