...
const CurrentPartners: React.FC = () => {
 return (
 <section className="py-20 bg-[#FAFAFA] dark:bg-[#0A111F] border-y border-gray-200 transition-colors duration-300">
 <div className="container mx-auto px-4 md:px-6 text-center">
 <motion.div 
 >
 <span className="text-dfw-red font-mono text-xs font-bold uppercase tracking-widest mb-6 block">Our Network</span>
 <h2 className="text-3xl font-header font-bold text-white uppercase mb-16 tracking-wide">Proud to Partner With</h2>
 </motion.div>
 ...
 >
 <div className="h-32 w-full bg-white/5 rounded-lg shadow-sm border border-white/10 flex items-center justify-center p-6 mb-6 group-hover:shadow-xl group-hover:border-dfw-red/30 transition-all duration-300">
 ...
 <span className="font-header font-bold text-xl text-white">CricKingdom</span>
 </div>
 </div>
 ...
 >
 <p className="text-xs text-gray-400 italic">Interested in joining our partner network? <Link href="/contact" className="text-white font-bold hover:text-dfw-red dark:hover:text-dfw-red underline decoration-dotted underline-offset-4">Get in touch.</Link></p>
 </motion.div>
 </div>
 </section>
 );
