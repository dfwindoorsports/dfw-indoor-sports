...
export default function RelatedPages({ pages, title = 'Related Pages' }: RelatedPagesProps) {
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-6">
 {title}
 </h3>
 ...
 key={page.href}
 href={page.href}
 className="group bg-white/5 border border-white/10 p-6 rounded-lg hover:shadow-lg hover:border-dfw-red/30 transition-all"
 >
 <h4 className="font-bold text-white mb-2 group-hover:text-dfw-red transition-colors flex items-center justify-between">
 {page.title}
