...
export function SkeletonCard({
 ...
 return (
 <div className={`rounded-2xl border border-white/10 bg-white dark:bg-white/[0.02] overflow-hidden ${className}`}>
...
export function SkeletonPricingCard({ className = '' }: { className?: string }) {
 return (
 <div className={`rounded-2xl border border-white/10 bg-white dark:bg-white/[0.02] p-8 ${className}`}>
