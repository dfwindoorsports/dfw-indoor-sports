...
const DodgeballLocation: React.FC = () => {
 return (
 <section className="py-20 bg-white/5 border-t border-gray-200">
 ...
 <p className="text-xs text-gray-600 leading-relaxed bg-[#050911] p-3 rounded-sm border border-gray-200">
