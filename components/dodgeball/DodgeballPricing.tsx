...
const DodgeballPricing: React.FC = () => {
 ...
 >
 <h2 className="text-4xl md:text-5xl font-header font-bold text-[#4C1D95] uppercase mb-6">Court Rental & Leagues</h2>
 <p className="text-gray-400">Simple pricing for casual play or competitive seasons.</p>
 </motion.div>
 ...
 {/* Hourly Rental */}
 <motion.div 
 className="bg-white/5 rounded-xl border border-white/10 p-8 hover:shadow-2xl transition-all duration-300 group relative overflow-hidden flex flex-col"
 >
 <div className="absolute top-0 left-0 w-full h-1 bg-violet-600"></div>
 <div className="flex justify-between items-start mb-6">
 <div>
 <h3 className="text-2xl font-header font-bold text-[#4C1D95] uppercase">Hourly Rental</h3>
 ...
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-violet-600 dark:text-violet-400" /> Private Regulation Court</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-violet-600 dark:text-violet-400" /> All Dodgeballs Included</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-violet-600 dark:text-violet-400" /> Safety Equipment Provided</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-violet-600 dark:text-violet-400" /> Spectator Seating</li>
 </ul>
 ...
 <div className="flex justify-between items-start mb-6">
 <div>
 <h3 className="text-2xl font-header font-bold text-[#4C1D95] uppercase">Rec League</h3>
 <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mt-1">8-Week Season</p>
 </div>
 <div className="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 text-orange-400 rounded-full flex items-center justify-center">
 <Trophy size={24} />
 </div>
 </div>
 ...
 <ul className="space-y-4 mb-8 flex-grow">
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-orange-500" /> Weekly Matches (8 Weeks)</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-orange-500" /> Referees Provided</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-orange-500" /> Playoffs & Championship</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-orange-500" /> Team or Individual Sign-up</li>
 </ul>
