...
const DodgeballBooking: React.FC = () => {
 return (
 <section className="py-24 bg-[#0A111F] transition-colors duration-300" id="booking-process">
 <div className="container mx-auto px-4 md:px-6">
 <div className="text-center mb-16">
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#4C1D95] uppercase mb-6">Three Ways To Play</h2>
 </div>
 ...
 {/* Online */}
 <motion.div
 className="bg-[#050911] dark:bg-white/5 p-8 rounded-lg border border-white/10 hover:shadow-lg transition-all text-center group"
 >
 ...
 <h3 className="text-xl font-header font-bold text-[#4C1D95] uppercase mb-4">1. Online Booking</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
 Instant Confirmation. Book 24/7. Best for hourly rentals. Check real-time availability.
 </p>
 <div className="text-left text-xs text-gray-400 space-y-2 mb-8 bg-white/5 p-4 rounded border border-gray-100">
 ...
 <h3 className="text-xl font-header font-bold text-[#4C1D95] uppercase mb-4">2. Call Us</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
 ...
 className="bg-[#050911] dark:bg-white/5 p-8 rounded-lg border border-white/10 hover:shadow-lg transition-all text-center group"
 >
 <div className="w-16 h-16 bg-white dark:bg-white/10 border-2 border-gray-300 text-gray-400 rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm group-hover:scale-110 transition-transform">
 <Calendar size={28} />
 </div>
 <h3 className="text-xl font-header font-bold text-gray-300 uppercase mb-4">3. Walk-In</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
 Subject to availability. Off-peak weekday mornings often have space. Evenings usually booked.
 </p>
 <div className="mb-8 text-xs text-gray-400 bg-white/5 p-4 rounded border border-gray-100">
 <p className="font-bold text-[#4C1D95] dark:text-violet-400 mb-1">16230 Three Wide Dr Suite 200</p>
 <p>Fort Worth, TX 76177</p>
 </div>
 <button className="w-full py-3 border border-gray-300 text-gray-400 font-bold uppercase text-xs tracking-widest rounded-sm cursor-not-allowed">Check Status</button>
 </motion.div>
