...
const DodgeballBooking: React.FC = () => {
   return (
      <section aria-label="Dodgeball booking process" className="py-24 md:py-32 bg-white transition-colors duration-300" id="booking-process">
         <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
               ...
               >
                  <div className="w-16 h-16 bg-dodgeball text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                     <MousePointer2 size={28} />
                  </div>
                  <h3 className="text-xl font-header font-bold text-dodgeball uppercase mb-4">1. Online Booking</h3>
               ...
               <motion.div
                  ...
                  className="bg-gray-50 p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all text-center group"
               >
                  <div className="w-16 h-16 bg-white border-2 border-dodgeball text-dodgeball rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm group-hover:scale-110 transition-transform">
                     <Phone size={28} />
                  </div>
                  <h3 className="text-xl font-header font-bold text-dodgeball uppercase mb-4">2. Call Us</h3>
                  <p className="text-xs text-gray-500 mb-6 leading-relaxed">
