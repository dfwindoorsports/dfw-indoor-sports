...
const DodgeballPackages: React.FC = () => {
 return (
 <section className="py-24 bg-[#050911] dark:bg-[#0A111F] border-t border-gray-200 transition-colors duration-300" id="packages">
 ...
 <h2 className="text-3xl md:text-4xl font-header font-bold text-[#4C1D95] uppercase">Birthday Parties</h2>
 </div>
 ...
 className={`bg-white/5 rounded-lg p-8 border transition-all duration-300 relative overflow-hidden group ${pkg.highlight ? 'border-orange-500 shadow-xl transform md:-translate-y-4' : 'border-white/10 shadow-sm hover:shadow-md'}`}
 >
 ...
 <h3 className="text-xl font-header font-bold text-[#4C1D95] uppercase mb-2">{pkg.name}</h3>
 <div className="flex items-baseline gap-1 mb-6">
 <span className="text-3xl font-bold text-white">{pkg.price}</span>
 <span className="text-xs text-gray-400">/ {pkg.kids} Kids</span>
 </div>
 <div className="flex items-center gap-2 mb-6 text-sm text-gray-300 bg-[#050911] dark:bg-white/10 p-2 rounded">
 ...
 <h2 className="text-3xl md:text-4xl font-header font-bold text-[#4C1D95] uppercase">Corporate Events</h2>
 </div>

 <div className="bg-[#4C1D95] rounded-xl overflow-hidden shadow-2xl relative text-white border border-white/10">
