...
const DodgeballIntro: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#4C1D95] uppercase leading-[0.95] mb-8">
 ...
 <p className="border-l-4 border-violet-500 pl-6 italic text-gray-200 font-medium my-8 bg-violet-50/50 dark:bg-violet-900/10 py-4 rounded-r-md">
"You'll burn 400-600 calories per hour sprinting, dodging, and diving without noticing because you're having too much fun."
 ...
 <p className="text-[10px] font-bold uppercase text-gray-400">Cardio Boost</p>
 </div>
 <div className="p-4 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10">
 <Zap className="mx-auto text-yellow-500 mb-2" size={24} />
 <p className="text-[10px] font-bold uppercase text-gray-400">Reflexes</p>
 </div>
 <div className="p-4 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10">
 <Smile className="mx-auto text-orange-500 mb-2" size={24} />
 <p className="text-[10px] font-bold uppercase text-gray-400">Stress Relief</p>
 </div>
 </div>
 </motion.div>
