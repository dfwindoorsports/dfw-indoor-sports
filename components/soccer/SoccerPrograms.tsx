...
const SoccerPrograms: React.FC = () => {
 return (
 <section className="bg-white py-24 border-b border-white/10">
 ...
 {/* Leagues */}
 <div className="bg-[#050911] p-8 rounded-lg border border-gray-200 hover:border-emerald-600 hover:-translate-y-1 transition-all group">
