...
const SoccerIntro: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#064E3B] uppercase leading-[0.95] mb-8">
 ...
 <p className="border-l-4 border-emerald-500 pl-6 italic text-gray-200 font-medium my-8 bg-emerald-50/50 dark:bg-emerald-900/10 py-4 rounded-r-md">
"Indoor soccer eliminates every obstacle while providing advantages impossible outdoors."
 ...
 <div className="p-4 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10">
 <Sun className="mx-auto text-orange-500 mb-2" size={24} />
 <p className="text-[10px] font-bold uppercase text-gray-400">No Heat Exhaustion</p>
 </div>
 <div className="p-4 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10">
 <CloudRain className="mx-auto text-blue-500 mb-2" size={24} />
 <p className="text-[10px] font-bold uppercase text-gray-400">No Rainouts</p>
 </div>
 <div className="p-4 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10">
 <Wind className="mx-auto text-gray-400 mb-2" size={24} />
 <p className="text-[10px] font-bold uppercase text-gray-400">No Wind Interference</p>
 </div>
 </div>
 </motion.div>
