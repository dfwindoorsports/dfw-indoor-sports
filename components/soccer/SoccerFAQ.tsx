...
const SoccerFAQ: React.FC = () => {
 return (
 <section className="py-24 bg-[#0A111F] border-t border-gray-100 transition-colors duration-300">
 <div className="container mx-auto px-4 md:px-6 max-w-3xl">
 <motion.h2 
 className="text-3xl font-header font-bold text-[#064E3B] uppercase mb-12 text-center"
 >
 ...
 >
 <summary className="flex justify-between items-center font-bold text-[#064E3B] uppercase tracking-wide text-xs select-none hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors list-none">
 {item.q}
 <span className="transition-transform group-open:rotate-180 text-gray-400">
 <ChevronDown size={16} />
 </span>
 </summary>
 <div className="pt-4 text-gray-300 text-sm leading-relaxed animate-fade-in-up pl-4 border-l-2 border-emerald-100 dark:border-emerald-500/20 mt-2">
 {item.a}
 </div>
 </motion.details>
 ))}
