...
const SoccerFeatures: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#064E3B] uppercase leading-tight mb-6">
 Professional Indoor <br/> Soccer Infrastructure
 </h2>
 <p className="text-gray-400">Every inch of our facility is engineered to support athlete development and safety.</p>
 </motion.div>
 ...
 className="bg-white/5 p-8 rounded-lg border border-white/10 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 hover:shadow-xl transition-all duration-500 group relative overflow-hidden h-full flex flex-col"
 >
 ...
 <div className="w-14 h-14 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-lg flex items-center justify-center border border-emerald-100 group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-300">
 <feat.icon size={28} strokeWidth={1.5} />
 </div>
 <span className="text-[10px] font-mono text-gray-300 group-hover:text-emerald-500 transition-colors">0{idx + 1}</span>
 </div>
 
 <h3 className="text-xl font-header font-bold text-white uppercase mb-3 group-hover:text-emerald-800 dark:group-hover:text-emerald-400 transition-colors">{feat.title}</h3>
