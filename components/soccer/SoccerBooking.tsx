...
const SoccerBooking: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#064E3B] uppercase mb-6">Three Ways To Reserve Your Soccer Field</h2>
 </div>
 ...
 <h3 className="text-xl font-header font-bold text-[#064E3B] uppercase mb-4">1. Online Booking</h3>
 ...
 <h3 className="text-xl font-header font-bold text-[#064E3B] uppercase mb-4">2. Phone Reservations</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
 ...
 <h3 className="text-xl font-header font-bold text-gray-300 uppercase mb-4">3. Walk-In Availability</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
