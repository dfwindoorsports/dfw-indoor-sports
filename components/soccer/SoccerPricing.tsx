...
const SoccerPricing: React.FC = () => {
 ...
 >
 <h2 className="text-4xl md:text-5xl font-header font-bold text-[#064E3B] uppercase mb-6">Soccer Field Rental Options</h2>
 <p className="text-gray-400">Flexible pricing for teams and individuals.</p>
 </motion.div>
 ...
 >
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Field Rental</h3>
 ...
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> 1 Indoor Field</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Professional Artificial Turf</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Goal Systems Included</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Up to 16 Players</li>
 </ul>
 ...
 >
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Team Packages</h3>
 ...
 <ul className="space-y-4 mb-8 flex-grow">
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Flexible Scheduling</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Guaranteed Weekly Slot</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Goals & Equipment Included</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-emerald-600 dark:text-emerald-400" /> Professional Artificial Turf</li>
 </ul>
 <Link href="/contact" className="w-full py-4 border-2 border-gray-200 text-gray-300 font-bold uppercase text-xs tracking-widest rounded-sm hover:border-[#064E3B] hover:text-[#064E3B] dark:hover:border-emerald-400 dark:hover:text-emerald-400 transition-colors flex items-center justify-center gap-2">
 ...
 {/* League Pricing */}
 <div className="mt-16 bg-[#050911] dark:bg-white/5 border border-white/10 rounded-lg p-8 max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
 <div>
 <h4 className="text-xl font-header font-bold text-[#064E3B] uppercase mb-2">League & Tournament Pricing</h4>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-400">
 <p><strong className="text-white">Leagues:</strong> Contact us for current season pricing and availability.</p>
 <p><strong className="text-white">Tournaments:</strong> Contact us for tournament pricing and booking details.</p>
 </div>
 </div>
 <Link href="/events" className="px-8 py-3 bg-white dark:bg-white/10 border border-gray-300 text-gray-700 font-bold uppercase text-xs tracking-widest rounded-sm hover:border-[#064E3B] hover:text-[#064E3B] dark:hover:bg-white dark:hover:text-[#064E3B] transition-colors whitespace-nowrap flex items-center gap-2">
