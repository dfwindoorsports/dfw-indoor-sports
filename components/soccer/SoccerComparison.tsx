...
const SoccerComparison: React.FC = () => {
 ...
 <h2 className="text-3xl font-header font-bold text-[#064E3B] uppercase mb-4">The Indoor Advantage</h2>
 <p className="text-gray-400">Why top players are moving indoors for technical development.</p>
 </div>
 ...
 <td className="p-5 md:p-6 bg-emerald-50/40 dark:bg-emerald-900/20 text-sm font-bold text-gray-800 flex items-center gap-2 border-x border-white/10">
 ...
 {/* Testimonials */}
 <div>
 <h2 className="text-3xl font-header font-bold text-[#064E3B] uppercase mb-12 text-center">Player Testimonials</h2>
 ...
 className="bg-white/5 p-8 rounded-lg border border-white/10 shadow-sm hover:shadow-xl transition-all duration-300 relative group h-full flex flex-col"
 >
 ...
 <p className="text-gray-300 text-sm italic mb-6 leading-relaxed flex-grow">"{t.text}"</p>
 <div>
 <p className="font-bold text-[#064E3B] uppercase text-xs">{t.name}</p>
