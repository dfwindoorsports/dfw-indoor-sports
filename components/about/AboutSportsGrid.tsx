    ...
    <section className="bg-white py-24 border-b border-gray-100 relative overflow-hidden transition-colors duration-300">
       <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
             ...
             <h2 className="text-4xl md:text-5xl font-header font-bold text-dfw-navy uppercase mb-6">Seven Sports. One Community.</h2>
             <p className="text-gray-500">Specialization without compromise. We embrace four key disciplines with professional focus.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
             {[
                ...
                <motion.div 
                  ...
                  className={`p-6 rounded-lg border transition-all duration-300 group cursor-default relative overflow-hidden ${
                     sport.featured 
                        ? 'bg-dfw-red border-dfw-red text-white' 
                        : 'bg-white border-gray-100 text-dfw-navy hover:shadow-lg hover:-translate-y-1'
                  }`}
                >
