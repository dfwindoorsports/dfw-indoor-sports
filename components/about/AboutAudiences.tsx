...
const AboutAudiences: React.FC = () => {
  ...
  return (
    <section aria-label="Who we serve" className="py-24 md:py-32 bg-white border-y border-gray-100 transition-colors duration-300">
       <div className="container mx-auto px-4 md:px-6">
          <motion.div 
            className="text-center mb-16"
          >
             <h2 className="text-4xl font-header font-bold text-dfw-navy uppercase mb-4">Athletes at Every Stage</h2>
             <p className="text-gray-500">From first-timers to national contenders, families to pros.</p>
          </motion.div>
          ...
          >
             {/* Youth */}
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 bg-green-50 text-green-600 rounded-full flex items-center justify-center mb-6">
                   <Star size={24} />
                </div>
                <h3 className="text-xl font-header font-bold text-dfw-navy uppercase mb-4">Youth (6-17)</h3>
             ...
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-header font-bold text-dfw-navy uppercase mb-4">Adult Rec</h3>
                <p className="text-sm text-gray-500 mb-6 leading-relaxed">
             ...
             <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl font-header font-bold text-dfw-navy uppercase mb-4">Families</h3>
                <p className="text-sm text-gray-500 mb-6 leading-relaxed">
             ...
             {/* Competitive */}
             <motion.div variants={itemVariants} className="bg-dfw-navy p-8 rounded-lg shadow-xl border border-dfw-navy hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
