...
const AboutValues: React.FC = () => {
 ...
 return (
 <section className="py-24 bg-[#050911] border-y border-gray-200 transition-colors duration-300" id="values">
 ...
 <h2 className="text-4xl md:text-5xl font-header font-bold text-white uppercase mb-6">Our Core Values</h2>
 <p className="text-gray-400">Excellence is the standard, but our values define the culture.</p>
 </motion.div>
 ...
 className="bg-white/5 p-8 rounded-lg shadow-sm border border-white/10 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
 >
 <div className="w-12 h-12 bg-dfw-navy/5 dark:bg-white/10 text-white rounded-lg flex items-center justify-center mb-6 group-hover:bg-dfw-red group-hover:text-white transition-colors">
 <val.icon size={24} />
 </div>
 <h3 className="text-xl font-header font-bold text-white uppercase mb-3">{val.title}</h3>
