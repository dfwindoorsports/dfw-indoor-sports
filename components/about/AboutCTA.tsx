       ...
       <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
             ...
             >
                ...
                <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-lg">
             ...
             >
                <Link href="/contact" className="px-8 py-4 bg-dfw-red text-white font-bold uppercase tracking-widest text-sm rounded-full hover:bg-red-700 transition-colors shadow-[0_0_30px_rgba(214,40,40,0.3)] flex items-center justify-center gap-2">
                   <Calendar size={16} /> Book Free Tour
                </Link>
                <Link href="/memberships" className="px-8 py-4 border border-white/20 text-white font-bold uppercase tracking-widest text-sm rounded-full hover:bg-white hover:text-dfw-navy transition-colors text-center">
                   View Memberships
                </Link>
             </motion.div>
          </div>
