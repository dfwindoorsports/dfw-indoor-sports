...
const AboutFacilitySpecs: React.FC = () => {
 return (
 <section className="bg-[#050911] dark:bg-[#0A111F] py-24 relative transition-colors duration-300">
 ...
 <h2 className="text-4xl md:text-5xl font-header font-bold text-white uppercase leading-[0.95] mb-6">
 Designed for <br /> Performance, <br /> Built for <span className="text-dfw-red">Comfort.</span>
 </h2>
 <p className="text-gray-400 leading-relaxed text-sm mb-8 border-l-2 border-white/10 pl-4">
 ...
 <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white group-hover:bg-dfw-red group-hover:text-white transition-colors">
 <Thermometer size={18} />
 </div>
 <div>
 <p className="font-bold text-white uppercase text-xs">Climate Control</p>
 ...
 <div>
 <p className="font-bold text-white uppercase text-xs">Pro Lighting</p>
 ...
 <div>
 <p className="font-bold text-white uppercase text-xs">Connected</p>
