...
const AboutLocation: React.FC = () => {
 return (
 <section className="py-24 bg-[#050911] transition-colors duration-300">
...
"I drive 40 minutes from Frisco. Worth every minute for facilities this good and community this strong." — Arjun K., Member
 ...
 <div>
 <h4 className="font-bold text-white uppercase text-xs mb-2 flex items-center gap-2"><MapPin size={12} className="text-dfw-red"/> Primary (10-20m)</h4>
 <p className="text-xs text-gray-400">Fort Worth, Arlington, Grand Prairie, HEB, Keller, Southlake</p>
 </div>
 <div>
 <h4 className="font-bold text-white uppercase text-xs mb-2 flex items-center gap-2"><MapPin size={12} className="text-dfw-red"/> Secondary (20-35m)</h4>
 <p className="text-xs text-gray-400">Irving, Carrollton, Coppell, Lewisville, Mansfield</p>
 </div>
 </div>
