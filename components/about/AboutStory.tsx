...
const AboutStory: React.FC = () => {
 return (
 <section className="py-24 md:py-32 bg-[#0A111F] relative transition-colors duration-300" id="story">
 ...
 <span className="text-white font-mono text-xs font-bold uppercase tracking-widest">Our Why</span>
 </div>
 ...
 <div className="p-6 bg-[#050911] dark:bg-white/5 border border-white/10 rounded-sm hover:border-dfw-red/30 transition-colors">
 ...
 >
 <div className="relative z-10 h-full min-h-[500px] rounded-sm overflow-hidden shadow-2xl group border border-white/10">
 <img 
