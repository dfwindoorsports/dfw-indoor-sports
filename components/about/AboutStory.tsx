          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
             ...
             >
                <div className="inline-flex items-center gap-2 mb-6">
                   <span className="w-2 h-2 bg-dfw-navy rounded-full"></span>
                   <span className="text-dfw-navy font-mono text-xs font-bold uppercase tracking-widest">Our Why</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="p-6 bg-gray-50 border border-gray-100 rounded-lg hover:border-dfw-red/30 transition-colors">
