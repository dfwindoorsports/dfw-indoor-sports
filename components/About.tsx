...
const About: React.FC = () => {
 ...
 {/* --- Values Grid --- */}
 <section className="bg-[#050911] py-20 md:py-32 border-y border-gray-200">
 ...
 <div className="w-16 h-16 mx-auto bg-[#050911] rounded-full flex items-center justify-center mb-6 group-hover:bg-dfw-red group-hover:text-white transition-colors duration-300">
 <item.icon size={28} />
 </div>
