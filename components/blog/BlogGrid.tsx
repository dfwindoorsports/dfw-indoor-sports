...
export default function BlogGrid({ posts }: { posts: BlogPost[] }) {
 ...
 >
 <span className="text-heading font-header text-white uppercase">Latest Updates</span>
 </motion.div>
 ...
 {/* Meta */}
 <div className="flex items-center gap-3 text-caption text-gray-400 /40 mb-4">
 ...
 {/* Title */}
 <h3 className="text-heading font-header text-white mb-3 group-hover:text-dfw-red-600 dark:group-hover:text-dfw-red-400 transition-colors duration-300 line-clamp-2">
 {post.title}
 </h3>

 {/* Excerpt */}
 <p className="text-body text-gray-400 leading-relaxed mb-6 line-clamp-3">
 {post.excerpt}
 </p>

 {/* CTA */}
 <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between">
 <span className="text-overline tracking-luxury text-white group-hover:text-dfw-red-500 transition-colors duration-300">
 Read Now
 </span>
