       ...
       <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-16">
             ...
             >
                ...
                <h2 className="text-4xl font-header font-bold text-dfw-navy uppercase mb-6">Your Passport To Play</h2>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
                   ...
                   <div className="flex justify-between items-end">
                      <div>
                         ...
                         <p className="font-bold text-dfw-navy">Unlimited Access</p>
                      </div>
                      <div className="text-right">
                         <span className="text-4xl font-header font-bold text-dfw-navy">$109</span>
                         <span className="text-xs text-gray-500">/mo</span>
                      </div>
                   </div>
                </div>
                <Link href="/memberships" className="text-dfw-red font-bold text-sm uppercase tracking-widest hover:text-dfw-navy transition-colors">See all membership benefits &rarr;</Link>
             </motion.div>

             <div className="lg:w-1/2">
                <div className="grid grid-cols-1 gap-6">
                   <motion.div 
                     className="flex gap-6 p-6 bg-white rounded-lg shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform cursor-default"
                   >
                      <div className="w-12 h-12 bg-green-50 text-green-600 rounded-full flex items-center justify-center shrink-0">
                         <Star size={24} />
                      </div>
                      <div>
                         <h3 className="font-header font-bold text-lg text-dfw-navy uppercase mb-1">For The Youth</h3>
                   ...
                   >
                      ...
                      <div>
                         <h3 className="font-header font-bold text-lg text-dfw-navy uppercase mb-1">For The Community</h3>
                         <p className="text-sm text-gray-500 leading-relaxed">
                   ...
                   >
                      ...
                      <div>
                         <h3 className="font-header font-bold text-lg text-dfw-navy uppercase mb-1">For Health</h3>
                         <p className="text-sm text-gray-500 leading-relaxed">
