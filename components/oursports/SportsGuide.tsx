       ...
       <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mb-24">
             ...
             >
                ...
                <h2 className="text-3xl md:text-5xl font-header font-bold text-dfw-navy uppercase mb-6">Find Your Fit</h2>
                <p className="text-gray-500">Not sure where to start? Here's a quick guide based on what you're looking for.</p>
             </motion.div>

             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Kids */}
                <motion.div 
                  className="bg-gray-50 p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all"
                >
                   <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-4 flex items-center gap-2">
                      <span className="w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-xs">01</span> For the Kids
                   </h3>
                   <ul className="space-y-4">
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Cricket Academy</span>
                         <p className="text-xs text-gray-500">Structure, discipline, and hand-eye coordination. Ages 6+.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Soccer Training</span>
                         <p className="text-xs text-gray-500">Energy burning, teamwork, and agility. Great for active kids.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Dodgeball Parties</span>
                         <p className="text-xs text-gray-500">The ultimate birthday experience. Pure fun with friends.</p>
                      </li>
                   </ul>
                </motion.div>
                ...
                >
                   <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-4 flex items-center gap-2">
                      <span className="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs">02</span> Stay Active
                   </h3>
                   <ul className="space-y-4">
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Badminton</span>
                         <p className="text-xs text-gray-500">The best cardio workout. Fast-paced, social, and easy to learn.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Social Dodgeball</span>
                         <p className="text-xs text-gray-500">Relieve work stress. Join a league or bring your co-workers.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Indoor Soccer</span>
                         <p className="text-xs text-gray-500">5-a-side games are intense and fun. Keep your touch sharp.</p>
                      </li>
                   </ul>
                </motion.div>
                ...
                >
                   <h3 className="font-header font-bold text-xl text-dfw-navy uppercase mb-4 flex items-center gap-2">
                      <span className="w-8 h-8 bg-dfw-red/10 text-dfw-red rounded-full flex items-center justify-center text-xs">03</span> Serious Training
                   </h3>
                   <ul className="space-y-4">
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Cricket Lanes</span>
                         <p className="text-xs text-gray-500">Bowling machines and video analysis for technique refinement.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Elite Badminton</span>
                         <p className="text-xs text-gray-500">Train on BWF flooring. Perfect your footwork and shots.</p>
                      </li>
                      <li>
                         <span className="font-bold text-dfw-navy text-sm block mb-1">Technical Soccer</span>
                         <p className="text-xs text-gray-500">Small-sided environment forces faster decision making.</p>
                      </li>
                   </ul>
                </motion.div>
             </div>
          ...
          {/* Getting Started */}
          <motion.div 
            className="bg-dfw-navy border border-white/10 rounded-2xl p-12 text-white relative overflow-hidden"
          >
