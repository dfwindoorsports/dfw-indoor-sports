    ...
    <section className="py-24 bg-[#050911] text-white relative overflow-hidden" id="showcase">
       ...
       <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="text-center mt-12">
             <button className="px-8 py-4 border border-white/20 text-white font-bold uppercase tracking-widest text-xs rounded-sm hover:bg-white hover:text-badminton transition-all flex items-center gap-3 mx-auto group">
