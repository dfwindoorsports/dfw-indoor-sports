...
const BadmintonPricing: React.FC = () => {
 ...
 >
 <h2 className="text-4xl md:text-5xl font-header font-bold text-[#1E3A8A] uppercase mb-6">Court Rental Rates</h2>
 <p className="text-gray-400">Transparent pricing for casual games or dedicated training.</p>
 </motion.div>
 ...
 >
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Court Rental</h3>
 ...
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> 1 BWF Professional Court</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> Nets & Posts Included</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> Singles or Doubles</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> Up to 6 Players</li>
 </ul>
 ...
 >
 <div className="mb-4">
 <h3 className="text-xl font-header font-bold text-white uppercase">Gold Access</h3>
 ...
 <ul className="space-y-4 mb-8 flex-grow">
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> <strong className="text-[#1E3A8A]">Badminton Unlimited</strong> Badminton</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> Unlimited Cricket Lanes</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> 10% Store Merchandise Discount</li>
 <li className="flex gap-3 text-sm text-gray-300"><Check size={16} className="text-blue-400" /> 10% Academy Coaching Discount</li>
 </ul>
 <Link href="/memberships" className="w-full py-4 border-2 border-gray-200 text-gray-300 font-bold uppercase text-xs tracking-widest rounded-sm hover:border-[#1E3A8A] hover:text-[#1E3A8A] dark:hover:border-blue-400 dark:hover:text-blue-400 transition-colors flex items-center justify-center gap-2">
