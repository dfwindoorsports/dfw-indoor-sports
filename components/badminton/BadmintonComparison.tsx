...
const BadmintonComparison: React.FC = () => {
 ...
 <h2 className="text-3xl font-header font-bold text-[#1E3A8A] uppercase mb-4">The BWF Standard</h2>
 <p className="text-gray-400">Why experienced players choose DFW Indoor Sports.</p>
 </div>
 ...
 <td className="p-5 md:p-6 bg-blue-50/40 dark:bg-blue-900/20 text-sm font-bold text-gray-800 flex items-center gap-2 border-x border-white/10">
 <Check size={16} className="text-blue-400" /> {row.us}
 </td>
 ...
 {/* Testimonials */}
 <div>
 <h2 className="text-3xl font-header font-bold text-[#1E3A8A] uppercase mb-12 text-center">Player Stories</h2>
 ...
 <div>
 <p className="font-bold text-[#1E3A8A] uppercase text-xs">{t.name}</p>
