...
const BadmintonFAQ: React.FC = () => {
  return (
    <section aria-label="Badminton frequently asked questions" className="py-24 md:py-32 bg-white border-t border-gray-100 transition-colors duration-300">
       <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          <motion.h2 
            className="text-3xl font-header font-bold text-badminton uppercase mb-12 text-center"
          >
            Badminton FAQ
          </motion.h2>
          ...
          <div className="divide-y divide-gray-200">
             {[
                ...
                >
                   <summary className="flex justify-between items-center font-bold text-badminton uppercase tracking-wide text-xs select-none hover:text-blue-500 transition-colors list-none">
                      {item.q}
                      <span className="transition-transform group-open:rotate-180 text-gray-400">
                         <ChevronDown size={16} />
                      </span>
                   </summary>
                   <div className="pt-4 text-gray-600 text-sm leading-relaxed animate-fade-in-up pl-4 border-l-2 border-blue-100 mt-2">
                      {item.a}
                   </div>
                </motion.details>
             ))}
