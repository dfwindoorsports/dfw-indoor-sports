...
const BadmintonFAQ: React.FC = () => {
 ...
 <motion.h2 
 className="text-3xl font-header font-bold text-[#1E3A8A] uppercase mb-12 text-center"
 >
 Badminton FAQ
 </motion.h2>
 ...
 >
 <summary className="flex justify-between items-center font-bold text-[#1E3A8A] uppercase tracking-wide text-xs select-none hover:text-blue-500 dark:hover:text-blue-400 transition-colors list-none">
 {item.q}
 <span className="transition-transform group-open:rotate-180 text-gray-400">
 <ChevronDown size={16} />
 </span>
 </summary>
 <div className="pt-4 text-gray-300 text-sm leading-relaxed animate-fade-in-up pl-4 border-l-2 border-blue-100 dark:border-blue-500/20 mt-2">
 {item.a}
 </div>
 </motion.details>
 ))}
