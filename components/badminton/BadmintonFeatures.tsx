...
const BadmintonFeatures: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#1E3A8A] uppercase leading-tight mb-6">
 Built For <span className="text-blue-600">Serious Play</span>
 </h2>
 <p className="text-gray-400">Every inch of our courts is engineered to support speed, agility, and precision.</p>
 </motion.div>
 ...
 className="bg-white/5 p-8 rounded-lg border border-white/10 hover:border-blue-500/50 dark:hover:border-blue-500/50 hover:shadow-xl transition-all duration-500 group relative overflow-hidden h-full flex flex-col"
 >
 ...
 <div className="w-14 h-14 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg flex items-center justify-center border border-blue-100 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
 <feat.icon size={28} strokeWidth={1.5} />
 </div>
 <span className="text-[10px] font-mono text-gray-300 group-hover:text-blue-500 transition-colors">0{idx + 1}</span>
 </div>
 
 <h3 className="text-xl font-header font-bold text-white uppercase mb-3 group-hover:text-blue-800 dark:group-hover:text-blue-400 transition-colors">{feat.title}</h3>
