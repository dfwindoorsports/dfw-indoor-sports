...
const BadmintonEquip: React.FC = () => {
 return (
 <section className="bg-[#050911] py-24 border-b border-white/10">
 ...
 <div className="px-4 py-2 bg-white/5 border border-gray-200 text-xs font-bold uppercase text-gray-400 rounded hover:border-blue-500 hover:text-blue-500 transition-colors cursor-default">Yonex</div>
 <div className="px-4 py-2 bg-white/5 border border-gray-200 text-xs font-bold uppercase text-gray-400 rounded hover:border-blue-500 hover:text-blue-500 transition-colors cursor-default">Victor</div>
 <div className="px-4 py-2 bg-white/5 border border-gray-200 text-xs font-bold uppercase text-gray-400 rounded hover:border-blue-500 hover:text-blue-500 transition-colors cursor-default">Li-Ning</div>
 </div>
 </div>
