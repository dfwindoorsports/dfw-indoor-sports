...
const BadmintonIntro: React.FC = () => {
 ...
 <h2 className="text-4xl md:text-6xl font-header font-bold text-[#1E3A8A] uppercase leading-[0.9] mb-8">
 The Perfect <br /> <span className="text-blue-400">Flight Path</span>
 </h2>
 ...
 <p className="border-l-4 border-blue-500 pl-6 italic text-gray-200 font-medium my-8">
"We engineered this facility to remove every variable. The ceiling is high, the air is still, and the floor grips. It's just you and the bird."
 ...
 <h4 className="font-bold text-[#1E3A8A] uppercase text-sm mb-2 flex items-center gap-2">
