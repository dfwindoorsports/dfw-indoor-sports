...
const ContactMethods: React.FC = () => {
 return (
 <section className="py-24 bg-[#050911] relative">
 ...
 <div className="bg-[#050911] p-5 rounded-lg border border-gray-100 text-center mb-8 group-hover:bg-blue-50/50 group-hover:border-blue-100 transition-colors">
 ...
 <div className="bg-[#050911] p-5 rounded-lg border border-gray-100 text-center mb-8 group-hover:bg-red-50/50 group-hover:border-red-100 transition-colors">
 ...
 <div className="bg-[#050911] p-5 rounded-lg border border-gray-100 text-center mb-8 group-hover:bg-green-50/50 group-hover:border-green-100 transition-colors">
