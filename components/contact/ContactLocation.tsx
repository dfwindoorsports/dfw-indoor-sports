...
const ContactLocation: React.FC = () => {
 ...
 <address className="not-italic mb-10 p-6 bg-[#050911] rounded-lg border border-gray-100 relative overflow-hidden group hover:border-dfw-navy/20 transition-colors">
