...
const ContactQuickAnswers: React.FC = () => {
 ...
 return (
 <section className="py-24 bg-white/5 border-b border-gray-100">
 ...
 className="w-full pl-10 pr-4 py-2 bg-[#050911] border border-gray-200 rounded-full text-xs focus:outline-none focus:border-dfw-navy transition-colors" 
 />
 ...
 <div key={i} className="p-8 rounded-lg bg-white/5 border border-gray-200 hover:border-dfw-navy/30 hover:shadow-lg transition-all duration-300 group cursor-default">
 ...
 <Link href={item.href} className="text-[10px] font-bold text-dfw-navy uppercase tracking-widest flex items-center gap-1 group-hover:gap-2 transition-all border-b border-white/10 pb-1 w-max group-hover:border-dfw-red">
