                ...
                {NAV_ITEMS.map((item) => (
                  <div key={item.label} className="relative group/menu">
                    {item.children ? (
                      <>
                        <button
                          className={`relative px-3 py-2 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest transition-colors duration-300 group-hover/menu:text-dfw-red ${pathname?.startsWith(item.href) ? 'text-white' : 'text-gray-500 dark:text-gray-400'
                            }`}
                        >
                          {item.label}
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 pt-4 w-56 opacity-0 invisible group-hover/menu:opacity-100 group-hover/menu:visible transition-all duration-300 transform translate-y-2 group-hover/menu:translate-y-0">
                          <div className="bg-white dark:bg-gray-900 border border-white/10 shadow-xl rounded-sm overflow-hidden p-1">
                      ...
                      <Link
                        href={item.href}
                        className={`relative px-3 py-2 block text-[11px] font-bold uppercase tracking-widest transition-colors duration-300 hover:text-dfw-red ${pathname === item.href ? 'text-white' : 'text-gray-500 dark:text-gray-400'
                          }`}
                      >
                        {item.label}
