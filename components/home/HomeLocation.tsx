...
const HomeLocation: React.FC = () => {
 ...
 <div className="bg-[#050911] dark:bg-[#0A111F] p-6 rounded-lg border border-white/10 mb-8 transition-colors">
 ...
 <div className="flex justify-between border-b border-white/10 pb-2"><span>Fort Worth</span> <span>10-15m</span></div>
 <div className="flex justify-between border-b border-white/10 pb-2"><span>Arlington</span> <span>15-20m</span></div>
 <div className="flex justify-between border-b border-white/10 pb-2"><span>Southlake</span> <span>15-25m</span></div>
 <div className="flex justify-between border-b border-white/10 pb-2"><span>West Dallas</span> <span>20-30m</span></div>
 </div>
 </div>
