             ...
             >
                ...
                <div className="grid grid-cols-2 gap-6">
                   {[
                      ...
                      <div key={i} className="p-4 bg-gray-50 rounded border border-gray-100 transition-colors">
                ...
                <Link href="/academy/coaches" className="inline-flex items-center gap-2 text-dfw-red font-bold uppercase text-xs tracking-widest border-b border-dfw-red/20 pb-1 hover:text-dfw-navy hover:border-dfw-navy transition-all">
