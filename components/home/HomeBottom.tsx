...
const HomeBottom: React.FC = () => {
 ...
 <h2 className="text-3xl font-header font-bold text-white uppercase">Latest Updates</h2>
 <Link href="/events" className="hidden md:flex items-center gap-2 text-xs font-bold text-white uppercase tracking-widest hover:text-dfw-red transition-colors">View All Events <ArrowRight size={14} aria-hidden="true" /></Link>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
 <div className="bg-white/5 p-6 rounded-lg shadow-sm border border-white/10 hover:shadow-md transition-all">
 <div className="text-dfw-red mb-4"><Bell size={20} /></div>
 <h3 className="font-bold text-white uppercase text-sm mb-2">Academy Enrollment Open</h3>
 <p className="text-xs text-gray-400 mb-4">CricKingdom spring session registration is now live. Limited spots available.</p>
 <span className="text-[10px] text-green-400 uppercase font-mono font-bold">Register Now</span>
 </div>
 <div className="bg-white/5 p-6 rounded-lg shadow-sm border border-white/10 hover:shadow-md transition-all">
 <div className="text-blue-600 mb-4"><Trophy size={20} /></div>
 <h3 className="font-bold text-white uppercase text-sm mb-2">Tournament Results</h3>
 <p className="text-xs text-gray-400 mb-4">Congratulations to the winners of our Winter Badminton Championship.</p>
 <span className="text-[10px] text-blue-400 uppercase font-mono font-bold">Results Posted</span>
 </div>
 <div className="bg-white/5 p-6 rounded-lg shadow-sm border border-white/10 hover:shadow-md transition-all">
 <div className="text-green-600 mb-4"><Calendar size={20} /></div>
 <h3 className="font-bold text-white uppercase text-sm mb-2">New Member Special</h3>
 <p className="text-xs text-gray-400 mb-4">Join in December to get 20% off first month + waived fees.</p>
