...
const HomePrograms: React.FC = () => {
   ...
   return (
      <section className="py-24 bg-[#0A111F] dark:bg-[#020408] border-b border-white/5 transition-colors duration-300">
         <div className="container mx-auto px-4 md:px-6">
            ...
            >
               <p className="text-gray-400">From beginners to champions, finding your level is the first step.</p>
            </motion.div>
            ...
            >
               ...
               {/* Youth */}
               <motion.div variants={cardVariants} className="group relative rounded-xl border border-white/10 hover:border-green-500/30 dark:hover:border-green-500/30 transition-all duration-300 overflow-hidden h-[480px]">
                  {/* Background Image */}
               ...
               {/* Adult */}
               <motion.div variants={cardVariants} className="group relative rounded-xl border border-white/10 hover:border-blue-500/30 dark:hover:border-blue-500/30 transition-all duration-300 overflow-hidden h-[480px]">
                  {/* Background Image */}
                  <div className="absolute inset-0">
                     <OptimizedImage
