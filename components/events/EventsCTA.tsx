...
const EventsCTA: React.FC = () => {
   return (
      <section aria-label="Plan your event" id="planning" className="py-24 md:py-32 bg-dfw-navy relative overflow-hidden text-center transition-colors duration-300">
