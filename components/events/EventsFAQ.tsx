...
const EventsFAQ: React.FC = () => {
 ...
 <h2 className="text-3xl font-header font-bold text-white uppercase mb-12 text-center">Event Planning FAQ</h2>
 ...
 className="group bg-white/5 rounded-sm border border-white/10 overflow-hidden transition-all duration-300 open:shadow-md"
 >
 <summary className="flex justify-between items-center p-6 cursor-pointer list-none font-bold text-white uppercase tracking-wide text-xs select-none hover:bg-gray-50 dark:hover:bg-white/10 transition-colors">
 {item.q}
 <span className="transition-transform group-open:rotate-180 text-gray-400">
 <ChevronDown size={16} />
 </span>
 </summary>
 <div className="p-6 pt-0 text-gray-300 text-sm leading-relaxed border-t border-gray-50 mt-2 ml-4 border-l-2 border-dfw-red/20 pl-4">
 {item.a}
 </div>
 </motion.details>
 ))}
