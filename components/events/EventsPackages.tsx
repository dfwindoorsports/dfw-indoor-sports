...
const EventsPackages: React.FC = () => {
 ...
 return (
 <section className="py-24 bg-[#050911] dark:bg-[#0A111F] border-y border-gray-200 transition-colors duration-300" id="packages">
 ...
 <h2 className="text-4xl md:text-5xl font-header font-bold text-white uppercase mb-6">Birthday Packages</h2>
 <p className="text-gray-400 max-w-2xl mx-auto">The best gift is an experience. Choose from Cricket, Dodgeball, Soccer, and more.</p>
 </motion.div>
 ...
 {/* Basic Package */}
 <motion.div variants={itemVariants} className="bg-white/5 rounded-lg border border-white/10 p-8 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Basic Sports</h3>
 ...
 <div className="pt-4 border-t border-white/10 text-xs text-gray-400 italic mb-6">
 *Bring your own food, cake & decor
 </div>
 <button className="w-full py-3 border border-dfw-navy text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-dfw-navy hover:text-white dark:hover:bg-white dark:hover:text-dfw-navy transition-colors">Select Basic</button>
 </motion.div>
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Ultimate Bash</h3>
 <div className="flex items-baseline gap-1 mb-6">
 <span className="text-4xl font-header font-bold text-white">Contact Us</span>
 ...
 <button className="w-full py-3 border border-dfw-navy text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-dfw-navy hover:text-white dark:hover:bg-white dark:hover:text-dfw-navy transition-colors">Select Ultimate</button>
 </motion.div>
 </motion.div>
 ...
 <p className="text-white font-bold">Contact <span className="text-xs font-normal">/ child</span></p>
 </div>
 <div className="bg-white/5 p-4 rounded border border-white/10">
 <p className="text-[10px] font-bold uppercase text-gray-400 mb-1">Extra Time</p>
 <p className="text-white font-bold">Contact <span className="text-xs font-normal">/ 30 min</span></p>
 </div>
 <div className="bg-white/5 p-4 rounded border border-white/10">
 ...
 <p className="text-white font-bold">Contact <span className="text-xs font-normal">/ session</span></p>
 </div>
 </div>
 </div>
 </section>
