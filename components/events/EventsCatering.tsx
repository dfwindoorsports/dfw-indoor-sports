...
const EventsCatering: React.FC = () => {
 ...
 >
 <h2 className="text-3xl font-header font-bold text-white uppercase tracking-wide mb-4">Custom Experiences</h2>
 <p className="text-gray-400 max-w-2xl mx-auto">Beyond tournaments and parties. If you can imagine it, we can host it.</p>
 </motion.div>
 ...
 <div key={i} className="flex gap-4 p-4 border border-white/10 rounded-lg hover:border-dfw-red/30 transition-colors bg-[#050911] dark:bg-white/5">
 <div className="p-2 bg-white dark:bg-white/10 rounded h-fit text-white"><item.icon size={20} /></div>
 <div>
 <h4 className="font-bold text-white text-sm uppercase mb-1">{item.title}</h4>
 ...
 <h2 className="text-2xl font-header font-bold text-white uppercase tracking-wide">Fuel Your Event</h2>
 </div>
 ...
 className="border border-white/10 p-6 rounded-sm hover:shadow-lg hover:border-dfw-red/20 transition-all text-center group cursor-default bg-white/5"
 >
 <div className="w-12 h-12 bg-[#050911] dark:bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-400 group-hover:text-dfw-red transition-colors">
 <menu.icon size={20} />
 </div>
 <h3 className="font-header font-bold text-white uppercase text-lg mb-1">{menu.title}</h3>
