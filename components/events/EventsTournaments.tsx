...
const EventsTournaments: React.FC = () => {
 return (
 <section className="py-24 bg-[#0A111F] border-b border-white/10 transition-colors duration-300" id="tournaments">
 ...
 <span className="text-white font-mono text-xs font-bold uppercase tracking-widest">Tournament Hosting</span>
 </div>
 <h2 className="text-4xl font-header font-bold text-white uppercase mb-6 leading-tight">
 ...
 <span className="text-sm text-gray-300">Cricket T20 & One-Day</span>
 </div>
 <div className="flex items-center gap-3">
 <CheckCircle2 size={16} className="text-green-500" />
 <span className="text-sm text-gray-300">Badminton Team/Individual</span>
 </div>
 <div className="flex items-center gap-3">
 <CheckCircle2 size={16} className="text-green-500" />
 <span className="text-sm text-gray-300">Volleyball 6v6</span>
 </div>
 </div>
 ...
 <div key={i} className="flex gap-4 p-6 bg-[#050911] dark:bg-white/5 rounded-lg border border-white/10 hover:border-dfw-red/20 transition-colors">
 <div className="p-2 bg-white dark:bg-white/10 rounded-md shadow-sm h-fit text-white">
 <item.icon size={20} />
 </div>
 <div>
 <h4 className="font-header font-bold text-white uppercase text-sm mb-1">{item.title}</h4>
 ...
 <tbody className="divide-y divide-gray-100 dark:divide-white/5 bg-[#0A111F]">
 <tr>
 <td className="p-4 font-bold text-white">Local League</td>
 <td className="p-4 text-gray-400 text-xs">Up to 8</td>
 <td className="p-4 text-gray-400 text-xs">1 Day</td>
 <td className="p-4 font-bold text-white text-right">Contact Us</td>
 </tr>
 <tr>
 <td className="p-4 font-bold text-white">Regional Champ</td>
 <td className="p-4 text-gray-400 text-xs">12-16</td>
 <td className="p-4 text-gray-400 text-xs">1-2 Days</td>
 <td className="p-4 font-bold text-white text-right">Contact Us</td>
 </tr>
 <tr>
 <td className="p-4 font-bold text-white">Multi-Day Series</td>
 <td className="p-4 text-gray-400 text-xs">16+</td>
 <td className="p-4 text-gray-400 text-xs">2-3 Days</td>
 <td className="p-4 font-bold text-white text-right">Custom</td>
 </tr>
 </tbody>
 </table>
 </div>
