...
const CoachesFAQ: React.FC = () => {
 ...
 >
 <h2 className="text-3xl md:text-5xl font-header font-bold text-white uppercase mb-6">Coaching FAQ</h2>
 ...
 >
 <summary className="flex justify-between items-center font-bold text-white uppercase tracking-wide text-sm select-none hover:text-dfw-red dark:hover:text-dfw-red transition-colors list-none">
 <span className="flex items-center gap-4">
 <span className="text-gray-300 font-mono text-xs">0{idx + 1}</span>
 {item.q}
 </span>
 <span className="bg-[#050911] dark:bg-white/10 p-2 rounded-full text-gray-400 group-hover:text-dfw-red transition-colors">
 <ChevronDown size={16} className="transition-transform group-open:rotate-180" />
 </span>
 </summary>
 <div className="pl-10 pr-4 pt-4 text-gray-400 text-sm leading-relaxed animate-fade-in-up">
 {item.a}
 </div>
 </motion.details>
 ))}
