...
const CoachesProfiles: React.FC = () => {
 ...
 <h2 className="text-5xl md:text-7xl font-header font-bold text-white uppercase leading-none mb-6">
 ...
 >
 <div className="absolute -top-20 -left-10 text-[150px] md:text-[200px] font-header font-bold text-gray-200/50 /5 select-none z-0 leading-none">01</div>
 
 <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
 <div className="lg:col-span-5 relative">
 <div className="relative aspect-[3/4] rounded-sm overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] border border-white/10">
 ...
 <span className="px-3 py-1 bg-dfw-navy dark:bg-white/10 text-white text-[10px] font-bold uppercase tracking-widest rounded-sm border border-transparent">Elite Tier</span>
 ...
 <p className="text-2xl md:text-3xl font-header font-bold text-white leading-tight italic">
"Technique is the foundation, but intelligence wins matches. We build <span className="text-dfw-red">thinking cricketers</span>."
 </p>
 </div>
 <div className="prose prose-lg text-gray-400 mb-10 leading-relaxed font-light">
 <p>
 ...
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4 flex items-center gap-2"><Activity size={14} className="text-dfw-red" /> Technical Focus</h4>
 {[{ label:"Batting Biomechanics", val:"95%" }, { label:"Video Analysis", val:"90%" }, { label:"Youth Psychology", val:"88%" }].map((skill, i) => (
 <div key={i}>
 <div className="flex justify-between text-[10px] font-bold uppercase text-gray-400 mb-1"><span>{skill.label}</span><span>{skill.val}</span></div>
 ...
 <div className="bg-white/5 p-6 rounded-sm border border-white/10 shadow-sm">
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4">Key Achievement</h4>
 <div className="flex items-start gap-4">
 <div className="p-2 bg-[#050911] dark:bg-white/10 text-dfw-red rounded-sm border border-gray-100"><Award size={20} /></div>
 <div><p className="font-bold text-white text-sm mb-1">Developed 20+ First Class Cricketers</p><p className="text-xs text-gray-400 leading-relaxed">Through structured pathway programs in Australia and India.</p></div>
 </div>
 </div>
 </div>
 </div>
 ...
 className="group relative"
 >
 <div className="absolute -top-20 -right-10 text-[150px] md:text-[200px] font-header font-bold text-gray-200/50 /5 select-none z-0 leading-none text-right w-full">02</div>
 <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
 ...
 <blockquote className="text-2xl md:text-3xl font-header font-bold text-white leading-tight italic">
"Every player is a unique puzzle. My job is to find the pieces that <span className="text-blue-600">unlock their potential</span>."
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-white/10 pt-8">
 <div className="space-y-4">
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4 flex items-center gap-2"><Brain size={14} className="text-blue-600" /> Strategic Focus</h4>
 ...
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4">Key Achievement</h4>
 <div className="flex items-start gap-4">
 <div className="p-2 bg-[#050911] dark:bg-white/10 text-blue-600 rounded-sm border border-gray-100"><Globe size={20} /></div>
 <div><p className="font-bold text-white text-sm mb-1">Multi-National Experience</p><p className="text-xs text-gray-400 leading-relaxed">Successfully managed academies in 4 different cricket nations.</p></div>
 </div>
 </div>
 </div>
 </div>
 ...
 className="group relative"
 >
 <div className="absolute -top-20 -left-10 text-[150px] md:text-[200px] font-header font-bold text-gray-200/50 /5 select-none z-0 leading-none">03</div>
 <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
 <div className="lg:col-span-5 relative">
 <div className="relative aspect-[3/4] rounded-sm overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] border border-white/10">
...
"Cricket builds character. I'm here to ensure the next generation in Texas <span className="text-green-600">falls in love</span> with the game."
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-white/10 pt-8">
 <div className="space-y-4">
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4 flex items-center gap-2"><Users size={14} className="text-green-600" /> Mentorship Focus</h4>
 ...
 <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-4">Key Achievement</h4>
 <div className="flex items-start gap-4">
 <div className="p-2 bg-[#050911] dark:bg-white/10 text-green-600 rounded-sm border border-gray-100"><Target size={20} /></div>
 <div><p className="font-bold text-white text-sm mb-1">DFW Community Leader</p><p className="text-xs text-gray-400 leading-relaxed">Instrumental in organizing youth leagues across North Texas.</p></div>
 </div>
 </div>
 </div>
 </div>
