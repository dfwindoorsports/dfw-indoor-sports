...
const CoachesIntro: React.FC = () => {
 ...
 <span className="text-white font-mono text-xs font-bold uppercase tracking-widest">The Human Connection</span>
 </div>
 <h2 className="text-3xl md:text-5xl font-header font-bold text-white uppercase leading-tight mb-8">
 We Coach People, <br/><span className="text-gray-400">Not Just Players.</span>
 </h2>
 <div className="prose prose-lg text-gray-400 leading-relaxed font-light">
 <p>
