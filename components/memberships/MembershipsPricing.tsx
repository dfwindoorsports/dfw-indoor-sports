...
const MembershipsPricing: React.FC = () => {
 ...
 return (
 <section className="py-24 bg-[#0A111F] relative transition-colors duration-300" id="pricing">
 ...
 <h2 className="text-4xl md:text-6xl font-header font-bold text-white uppercase mb-6">Choose Your Plan</h2>

 {/* Toggle */}
 <div className="flex justify-center items-center gap-4 mb-8">
 <span className={`text-xs font-bold uppercase tracking-widest transition-colors ${billingCycle === 'monthly' ? 'text-white' : 'text-gray-400'}`}>Monthly Flex</span>
 <button
 ...
 <span className={`text-xs font-bold uppercase tracking-widest transition-colors ${billingCycle === 'halfYearly' ? 'text-white' : 'text-gray-400'}`}>
 ...
 {/* Card 1: Badminton */}
 <motion.div
 className="bg-[#0A111F] rounded-lg border border-white/10 p-8 shadow-sm hover:shadow-xl transition-all duration-300 relative group overflow-hidden"
 >
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Badminton Unlimited</h3>
 <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-6">Court Access Only</p>

 <div className="mb-6 h-16">
 <span className="text-4xl font-header font-bold text-white animate-fade-in-up key-{billingCycle}">
...
"Unlimited Court Access","No Hourly Fees","No Additional Court Fees","Open Daily 5AM-11PM","10% Pro Shop Discount"
 ...
 <a href="https://book.runswiftapp.com/facilities/dfw-indoor-sports/memberships" target="_blank" rel="noopener noreferrer" className="w-full py-3 border border-dfw-navy text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-dfw-navy hover:text-white dark:hover:bg-white dark:hover:text-dfw-navy transition-colors block text-center">
 Select Plan
 </a>
 </motion.div>
...
"Unlimited Cricket + Badminton","Bowling Machine Included","10% Store Discount","10% Academy Discount","Bowling Machine Included"
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Cricket Unlimited</h3>
...
"Unlimited Lane Access","Bowling Machine Included","No Additional Court Fees","Video Analysis Allowed","10% Academy Discount"
 ...
 <button className="w-full py-3 border border-dfw-navy text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-dfw-navy hover:text-white dark:hover:bg-white dark:hover:text-dfw-navy transition-colors">
 Select Plan
 </button>
 </motion.div>
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Family Gold</h3>
...
"Covers 2 Adults + 2 Kids","Unlimited Cricket + Badminton","Simultaneous Use","Bowling Machine Included","10% Coaching Discount"
 ...
 <a href="https://book.runswiftapp.com/facilities/dfw-indoor-sports/memberships?membershipId=3675" target="_blank" rel="noopener noreferrer" className="w-full py-3 border border-dfw-navy text-white font-bold uppercase text-xs tracking-widest rounded-sm hover:bg-dfw-navy hover:text-white dark:hover:bg-white dark:hover:text-dfw-navy transition-colors block text-center">
 Select Plan
 </a>
 </motion.div>
 ...
 <p className="text-xs text-gray-400">• No additional Court/Lane fees for reserving</p>
 <p className="text-xs text-gray-400">• There is a one-time registration fee for all members of $20</p>
 <p className="text-xs text-gray-400">• All prices are before sales tax</p>
 <p className="text-xs text-gray-400">• Registration fee is a one-time fee and is not refundable upon account cancellation</p>
