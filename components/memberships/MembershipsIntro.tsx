...
const MembershipsIntro: React.FC = () => {
 ...
 <span className="text-white font-mono text-xs font-bold uppercase tracking-widest">Commit to Yourself</span>
 </div>
 ...
 <p>
 <strong className="text-white">The math is simple:</strong> if you play more than twice a month, membership pays for itself. But the real value is the freedom to treat this facility as your own.
 </p>
 </div>
