...
const MembershipsFAQ: React.FC = () => {
 ...
 <summary className="flex justify-between items-center cursor-pointer list-none font-bold text-white uppercase tracking-wide text-xs select-none hover:text-dfw-red dark:hover:text-dfw-red transition-colors py-4">
 {item.q}
 <span className="transition-transform group-open:rotate-180 text-gray-400">
 <ChevronDown size={16} />
 </span>
 </summary>
 <div className="pt-2 pb-4 text-gray-400 text-sm leading-relaxed animate-fade-in-up">
 {item.a}
 </div>
 </details>
 ))}
