...
const CricketFAQ: React.FC = () => {
 ...
 <motion.h2 
 className="text-3xl font-header font-bold text-[#006838] uppercase mb-12 text-center"
 >
 Cricket Rental FAQ
 </motion.h2>
 ...
 >
 <summary className="flex justify-between items-center font-bold text-[#006838] uppercase tracking-wide text-xs select-none hover:text-[#CC0000] dark:hover:text-green-400 transition-colors list-none">
 {item.q}
 <span className="transition-transform group-open:rotate-180 text-gray-400">
 <ChevronDown size={16} />
 </span>
 </summary>
 <div className="pt-4 text-gray-300 text-sm leading-relaxed animate-fade-in-up pl-4 border-l-2 border-[#CC0000]/10 dark:border-green-500/20 mt-2">
 {item.a}
 </div>
 </motion.details>
 ))}
