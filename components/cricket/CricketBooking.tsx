      ...
      <section aria-label="Cricket booking process" className="py-24 bg-white transition-colors duration-300" id="booking-process">
         <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
               ...
               >
                  <div className="w-16 h-16 bg-cricket text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                     <MousePointer2 size={28} />
                  </div>
                  <h3 className="text-xl font-header font-bold text-cricket uppercase mb-4">1. Book Online</h3>
                  ...
                  <div className="text-left text-xs text-gray-500 space-y-2 mb-8 bg-white p-4 rounded border border-gray-100">
                     <div className="flex gap-2"><UserPlus size={14} className="text-dfw-red-700" /> 1. Create Profile</div>
                     <div className="flex gap-2"><Calendar size={14} className="text-dfw-red-700" /> 2. Select Slot</div>
                     <div className="flex gap-2"><CreditCard size={14} className="text-dfw-red-700" /> 3. Secure Payment</div>
                  </div>
                  <a href="https://book.runswiftapp.com/facilities/dfw-indoor-sports/rentals" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-dfw-red-700 text-white font-bold uppercase text-xs tracking-widest rounded-lg hover:bg-red-700 transition-colors block text-center">Book Now</a>
               </motion.div>
               ...
               <motion.div
                  ...
                  className="bg-gray-50 p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all text-center group"
               >
                  <div className="w-16 h-16 bg-white border-2 border-cricket text-cricket rounded-full flex items-center justify-center mx-auto mb-6 shadow-sm group-hover:scale-110 transition-transform">
                     <Phone size={28} />
                  </div>
                  <h3 className="text-xl font-header font-bold text-cricket uppercase mb-4">2. Call Us</h3>
                  <p className="text-xs text-gray-500 mb-6 leading-relaxed">
                  ...
                  <a href="tel:8179380808" className="block w-full py-3 border border-cricket text-cricket font-bold uppercase text-xs tracking-widest rounded-lg hover:bg-cricket hover:text-white transition-colors">Click To Call</a>
               </motion.div>
               ...
               >
                  ...
                  <div className="mb-8 text-xs text-gray-500 bg-white p-4 rounded border border-gray-100">
                     <p className="font-bold text-cricket mb-1">16230 Three Wide Dr Suite 200</p>
