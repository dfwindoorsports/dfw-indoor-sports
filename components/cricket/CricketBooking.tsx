...
const CricketBooking: React.FC = () => {
 ...
 <h2 className="text-3xl md:text-5xl font-header font-bold text-[#006838] uppercase mb-6">Three Easy Ways To Book</h2>
 </div>
 ...
 <h3 className="text-xl font-header font-bold text-[#006838] uppercase mb-4">1. Book Online</h3>
 ...
 <h3 className="text-xl font-header font-bold text-[#006838] uppercase mb-4">2. Call Us</h3>
 <p className="text-xs text-gray-400 mb-6 leading-relaxed">
