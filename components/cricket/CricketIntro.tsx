...
const CricketIntro: React.FC = () => {
 ...
 <h2 className="text-4xl md:text-6xl font-header font-bold text-[#006838] uppercase leading-[0.9] mb-8">
 Fort Worth's Premier <br /> <span className="text-green-400">Indoor Hub</span>
 </h2>
 ...
 <p className="border-l-4 border-[#006838] pl-6 italic text-gray-200 font-medium my-8">
"We solved the Texas cricket problem. No heat exhaustion, no uneven bounce, no rain delays. Just perfect cricket."
 ...
 <h4 className="font-bold text-[#006838] uppercase text-sm mb-2 flex items-center gap-2">
