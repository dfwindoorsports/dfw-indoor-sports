...
const CricketComparison: React.FC = () => {
  return (
    <section aria-label="Cricket facility comparison" className="py-24 md:py-32 bg-gray-50 border-t border-gray-200 transition-colors duration-300">
       <div className="container mx-auto px-4 md:px-6">
          
          {/* Comparison Table */}
          <div className="max-w-5xl mx-auto mb-24">
             <div className="text-center mb-12">
                <h2 className="text-3xl font-header font-bold text-cricket uppercase mb-4">The DFW Standard</h2>
                <p className="text-gray-500">How we stack up against typical nets.</p>
             </div>
             
             <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <table className="w-full text-left border-collapse">
                   <thead>
                      <tr className="bg-cricket text-white">
                   ...
                   <tbody className="divide-y divide-gray-100 text-gray-700">
                      {[
                         ...
                         <tr key={i} className="hover:bg-gray-50 transition-colors">
                            <td className="p-5 md:p-6 font-bold text-cricket text-sm">{row.feat}</td>
                            <td className="p-5 md:p-6 bg-green-50/30 text-sm font-bold text-gray-800 flex items-center gap-2 border-x border-gray-100">
                               <Check size={16} className="text-green-600" /> {row.us}
                            </td>
          ...
          {/* Testimonials */}
          <div>
             <h2 className="text-3xl font-header font-bold text-cricket uppercase mb-12 text-center">Player Results</h2>
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                   ...
                   >
                      <div className="absolute top-0 left-0 w-full h-1 bg-gray-100 group-hover:bg-cricket transition-colors"></div>
