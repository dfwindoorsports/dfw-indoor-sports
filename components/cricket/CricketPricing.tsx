      ...
      <section className="py-24 bg-white dark:bg-[#020408] transition-colors duration-300" id="pricing">
         <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch">
               ...
               >
                  <div className="mb-4">
                     <h3 className="text-xl font-header font-bold text-gray-900 dark:text-white uppercase">Lane Rental</h3>
               ...
               >
                  <div className="mb-4">
                     <h3 className="text-xl font-header font-bold text-gray-900 dark:text-white uppercase">GOLD Membership</h3>
                  ...
                  <ul className="space-y-4 mb-8 flex-grow">
                     <li className="flex gap-3 text-sm text-gray-600 dark:text-gray-300"><Check size={16} className="text-green-600 dark:text-green-400" /> Unlimited Cricket Lanes</li>
                     <li className="flex gap-3 text-sm text-gray-600 dark:text-gray-300"><Check size={16} className="text-green-600 dark:text-green-400" /> Unlimited Badminton Courts</li>
                     <li className="flex gap-3 text-sm text-gray-600 dark:text-gray-300"><Check size={16} className="text-green-600 dark:text-green-400" /> 10% Store Merchandise Discount</li>
                     <li className="flex gap-3 text-sm text-gray-600 dark:text-gray-300"><Check size={16} className="text-green-600 dark:text-green-400" /> 10% Academy Coaching Discount</li>
                  </ul>
