...
const RentalsPricing: React.FC = () => {
 ...
 <motion.div 
 className="overflow-x-auto rounded-lg shadow-sm border border-white/10"
 >
 ...
 <tbody className="text-sm text-gray-300 divide-y divide-gray-100 dark:divide-white/5 bg-[#0A111F]">
 {[
 ...
 <td className="p-5 font-bold text-white">{row.name}</td>
 <td className="p-5 font-mono text-dfw-red font-bold">{row.rate}</td>
 <td className="p-5 font-mono text-green-400">{row.off}</td>
 ...
 <div className="mt-6 flex flex-wrap justify-between items-center text-xs text-gray-400">
