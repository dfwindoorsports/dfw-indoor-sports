...
const RentalsIntro: React.FC = () => {
  ...
  return (
    <section aria-label="Rentals introduction" className="py-24 md:py-32 bg-white relative">
         <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
               ...
               >
                  ...
                  <motion.div variants={itemVariants} className="prose prose-lg text-gray-500 leading-relaxed mb-10">
                     <p>
                  ...
                  <motion.div variants={itemVariants} className="bg-gray-50 p-6 rounded-lg border border-gray-100 backdrop-blur-sm relative overflow-hidden">
               ...
               >
                  <div className="grid grid-cols-1 gap-6">
                     <motion.div variants={itemVariants} className="bg-white p-8 rounded-lg shadow-xl border border-gray-100 group hover:-translate-y-1 transition-all duration-300">
