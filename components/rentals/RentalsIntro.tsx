...
const RentalsIntro: React.FC = () => {
 ...
 <span className="text-white font-mono text-xs font-bold uppercase tracking-widest">The DFW Advantage</span>
 </div>
 ...
 <div className="prose prose-lg text-gray-400 leading-relaxed mb-10">
 <p>
 ...
 <div className="bg-[#050911] dark:bg-white/5 p-6 rounded-lg border border-white/10 backdrop-blur-sm relative overflow-hidden transition-colors">
 <div className="absolute top-0 right-0 w-20 h-20 bg-dfw-red/5 dark:bg-dfw-red/10 rounded-bl-full"></div>
 <h3 className="font-bold text-white uppercase text-sm mb-4 relative z-10">Rental Quick Facts</h3>
 ...
 <div className="bg-white/5 p-8 rounded-lg shadow-xl border border-white/10 group hover:-translate-y-1 transition-all duration-300">
 <div className="w-12 h-12 bg-blue-50 dark:bg-blue-900/30 text-blue-400 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
 <Thermometer size={24} />
 </div>
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Climate Perfection</h3>
 ...
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Pro Equipment Included</h3>
 <p className="text-sm text-gray-400 leading-relaxed">
 ...
 <div className="bg-white/5 p-8 rounded-lg shadow-xl border border-white/10 group hover:-translate-y-1 transition-all duration-300">
 <div className="w-12 h-12 bg-green-50 dark:bg-green-900/30 text-green-400 rounded-lg flex items-center justify-center mb-4 group-hover:bg-green-600 group-hover:text-white transition-colors">
 <Clock size={24} />
 </div>
 <h3 className="text-xl font-header font-bold text-white uppercase mb-2">Flexible Booking</h3>
 <p className="text-sm text-gray-400 leading-relaxed">
