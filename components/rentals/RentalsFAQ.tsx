...
const RentalsFAQ: React.FC = () => {
 ...
 >
 <h3 className="font-header font-bold text-white uppercase text-2xl mb-8">Booking Policies</h3>
 <div className="space-y-8">
 <div>
 <h4 className="flex items-center gap-2 font-bold text-white text-sm uppercase mb-2">
 ...
 >
 <h3 className="font-header font-bold text-white uppercase text-2xl mb-8">Rental FAQ</h3>
 ...
 className="group bg-[#050911] dark:bg-white/5 rounded-sm border border-white/10 overflow-hidden transition-all duration-300 open:shadow-md"
 >
 <summary className="flex justify-between items-center p-4 cursor-pointer list-none font-bold text-white uppercase tracking-wide text-xs select-none hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
 {item.q}
