...
const WaiverDocument: React.FC = () => {
 ...
 return (
 <section className="py-20 bg-[#050911] relative">
 {/* Texture */}
 ...
 <section className="mt-8 p-6 bg-[#050911] rounded-lg border border-gray-200">
 ...
 <div className="bg-gray-100 p-8 md:p-12 border-x border-b border-white/10 rounded-b-lg" id="waiver-form">
 ...
 className={`w-6 h-6 rounded-sm border flex items-center justify-center transition-colors ${isMinor ? 'bg-dfw-navy border-dfw-navy text-white' : 'bg-white/5 border-gray-400'}`}
 >
 ...
 <input type="text" className="w-full p-3 rounded-sm border border-gray-300 bg-[#050911]" />
 </div>
 <div>
 ...
 className={`mt-1 w-6 h-6 shrink-0 rounded-sm border flex items-center justify-center transition-colors ${agreed ? 'bg-dfw-red border-dfw-red text-white' : 'bg-white/5 border-gray-400 hover:border-dfw-red'}`}
 >
