...
export default function CityFeatures({ title, description, features }: CityFeaturesProps) {
 ...
 className="group"
 >
 <div className="h-full bg-white/5 p-8 rounded-xl border border-white/10 hover:border-dfw-red/30 hover:-translate-y-1 transition-all duration-300">
 ...
 <h3 className="text-lg font-header font-bold text-white uppercase tracking-tight mb-2 group-hover:text-dfw-red transition-colors">
 {feature.title}
 </h3>
