...
export default function CityDirections({ city, address, googleMapsLink, directions }: {
 ...
 return (
 <section className="py-20 bg-[#050911] dark:bg-[#0a111f] relative overflow-hidden">
 {/* Subtle overlay */}
 ...
 className="text-2xl md:text-4xl font-header font-bold text-white uppercase tracking-tighter mb-4"
 >
 ...
 className="group"
 >
 <div className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-dfw-red/30 transition-colors">
 {/* Header */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
 <h3 className="text-lg font-header font-bold text-white flex items-center gap-3">
 ...
 <span className="px-3 py-1 bg-white/10 border border-white/10 rounded text-xs font-mono text-white">
 {dir.distance}
 </span>
 ...
 {/* Steps */}
 <ol className="relative border-l-2 border-white/10 ml-5 space-y-3">
 {dir.steps.map((step, sIdx) => (
 <li key={sIdx} className="pl-6 relative">
 <span className="absolute -left-[7px] top-1.5 w-3 h-3 rounded-full bg-white dark:bg-[#0a111f] border-2 border-gray-300" />
