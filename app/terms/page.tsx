...
export default function TermsOfServicePage() {
 ...
 return (
 <div className="bg-[#0A111F] min-h-screen pt-24 pb-12 font-sans transition-colors duration-300">
 <script
 type="application/ld+json"
 dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema) }}
 />
 <div className="container mx-auto px-4 md:px-6 max-w-4xl">
 <h1 className="text-4xl font-header font-bold text-white uppercase mb-8">Terms of Service</h1>
