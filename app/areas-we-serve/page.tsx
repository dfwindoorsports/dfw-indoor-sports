...
export default function AreasWeServePage() {
 ...
 return (
 <div className="bg-[#0A111F] min-h-screen transition-colors duration-300">
 <script
 ...
 <section className="py-16 bg-[#050911] dark:bg-[#0a111f]">
 <div className="container mx-auto px-4 text-center">
 <div className="inline-flex items-center gap-4 bg-white/5 px-6 py-4 rounded-lg shadow-md">
 <MapPin className="text-dfw-red" size={24} />
 <div className="text-left">
 <p className="font-bold text-white">Our Location</p>
 <p className="text-gray-400 text-sm">16230 Three Wide Drive Suite 200, Fort Worth, TX 76177</p>
 </div>
 ...
 <p className="text-gray-400 text-sm">5:00 AM - 11:00 PM</p>
 </div>
 </div>
 </div>
 </section>
 ...
 className="group bg-white/5 border border-white/10 rounded-xl p-8 hover:shadow-xl hover:border-dfw-red/30 transition-all duration-300"
 >
 <div className="flex items-start justify-between mb-4">
 <h3 className="text-2xl font-header font-bold text-white uppercase group-hover:text-dfw-red transition-colors">
 {city.name}
 </h3>
 <span className="bg-gray-100 dark:bg-white/10 px-3 py-1 rounded-full text-xs font-bold text-gray-400">
 {city.distance}
 </span>
 </div>
