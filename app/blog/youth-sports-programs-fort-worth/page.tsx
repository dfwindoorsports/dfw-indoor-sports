...
export default function YouthSportsPage() {
 ...
 <li key={i} className="bg-[#050911] dark:bg-white/5 p-4 rounded-lg">
 ...
 <h2 className="text-2xl font-bold text-white mb-4">Top Programs at DFW Indoor Sports</h2>
 ...
 <p className="text-sm text-gray-400">Ages 6-16. From holding the bat to advanced spin bowling techniques.</p>
 </div>
 <div className="border border-white/10 p-6 rounded-xl">
 <h3 className="text-xl font-bold text-dfw-red mb-2">Junior Badminton</h3>
 <p className="text-sm text-gray-400">Improve agility and coordination with our fast-paced badminton clinics.</p>
 </div>
 </div>
