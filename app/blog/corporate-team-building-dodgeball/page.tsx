...
export default function CorporateDodgeballPage() {
 ...
 <h2 className="text-2xl font-bold text-white mb-4">Why Dodgeball?</h2>
 ...
 <h3 className="font-bold mb-2 text-white">Inclusive</h3>
 <p className="text-sm text-gray-400">Easy rules, no prior skill needed. Everyone can play.</p>
 </div>
 <div className="bg-[#050911] dark:bg-white/5 p-6 rounded-xl text-center">
 <Briefcase className="mx-auto text-dfw-red mb-4" size={32} />
 <h3 className="font-bold mb-2 text-white">Stress Relief</h3>
 <p className="text-sm text-gray-400">Physically throwing (soft) objects is a great stress buster.</p>
 </div>
 <div className="bg-[#050911] dark:bg-white/5 p-6 rounded-xl text-center">
 <Star className="mx-auto text-dfw-red mb-4" size={32} />
 <h3 className="font-bold mb-2 text-white">Fun First</h3>
 <p className="text-sm text-gray-400">Laughter is guaranteed, which bonds teams instantly.</p>
 </div>
 </div>
