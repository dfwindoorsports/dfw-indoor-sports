...
export default function IndoorSoccerRulesPage() {
 ...
 <td className="p-4 font-bold text-white">Field</td>
 <td className="p-4 text-gray-400">Smaller, enclosed by walls</td>
 <td className="p-4 text-gray-400">Large, open field</td>
 </tr>
 <tr className="border-b border-white/10">
 <td className="p-4 font-bold text-white">Players</td>
 <td className="p-4 text-gray-400">5v5 or 6v6</td>
 <td className="p-4 text-gray-400">11v11</td>
 </tr>
 <tr className="border-b border-white/10">
 <td className="p-4 font-bold text-white">Offside</td>
 <td className="p-4 text-gray-400">No offside rule</td>
 <td className="p-4 text-gray-400">Offside enforced</td>
 </tr>
 <tr className="border-b border-white/10">
 <td className="p-4 font-bold text-white">Subs</td>
 <td className="p-4 text-gray-400">Unlimited, on the fly</td>
 <td className="p-4 text-gray-400">Limited, play stoppage</td>
 </tr>
 </tbody>
 </table>
 </div>

 <h3 className="text-2xl font-bold text-white mb-4">Playing off the Walls</h3>
